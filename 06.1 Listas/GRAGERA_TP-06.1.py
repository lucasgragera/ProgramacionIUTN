...
lista.append('Lucas')
lista.append('Ignacio')
lista.append('Gragera')
...
#La lista previamente presentada encuentra el numero maximo de la lista (22), lo elimina, y luego imprime la lista
#actualizada sin el 22
